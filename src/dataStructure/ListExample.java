...
public class ListExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("The original list is as a follow");
		...
		System.out.println("Value in the list before sorting");
		System.out.println(empNameAL);
		
		//Short the list ascending order
		Collections.sort(empNameAL);
		System.out.println("Values in list after sorting");
		System.out.println(empNameAL);
		
		
		//Short the list reverse order descending 
